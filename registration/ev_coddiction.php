	...
	<div id="fh5co-page">
		...
		<aside id="fh5co-aside" role="complementary" class="border js-fullheight">
			...
			<nav id="fh5co-main-menu" role="navigation">
				<ul>
					...
					<li class="fh5co-active"><a href="events.html">Events</a></li>
					<li><a href="../glimpse.html">Glimpse's</a></li>
					<li><a href="../sponsorus.html">Sponsor Us</a></li>
					<li><a href="../aboutus.html">About Us</a></li>
					<li><a href="../contactus.html">Contact Us</a></li>
					<li><a href="../webd/webd.html">WebDev Team</a></li>
				</ul>
			</nav>
		...
		<div id="fh5co-main" style="height: 100vh; background-image: none;">
			<div class="fh5co-narrow-content">
				<h2 class="fh5co-heading animate-box" style="color: black;" data-animate-effect="fadeInLeft">Coddiction</h2>
				<div class="row row-bottom-padded-md">
					<form action="update.php" method="get">					
						<div class="input-group">
						<span class="input-group-addon">Name of the team:</span>
						<input type="text" class="form-control" name="name_of_team">
						</div>
						<br>
						<div class="input-group">
							<span class="input-group-addon">Mail ID: </span>
							<input type="text" class="form-control" placeholder="Recipient's username">
							<p class="help-block">This will be our point of contact to the team.</p>
						</div>
						<br>
						<div class="input-group">
